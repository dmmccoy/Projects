        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Find Book<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="GetTaggedBooks">Home (Level 100)</a></li>
                          <li class="divider"></li>
                          <li><a href="AddTag">Change Tags</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
